...
def compute_topk(scoring_i2t, scoring_t2i, images_embeddings, text_embeddings, labels, k=[1, 10]):
    scoring_i2t = scoring_i2t.cuda()
    scoring_t2i = scoring_t2i.cuda()
    images_embeddings = images_embeddings.cuda()
    ...
    del images_embeddings, images_embeddings_norm, text_embeddings, text_embeddings_norm
    result = []
